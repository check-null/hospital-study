package com.sub.manager.service.impl;

import com.alibaba.fastjson.JSONObject;
import com.sub.manager.mapper.OrderInfoMapper;
import com.sub.manager.mapper.ScheduleMapper;
import com.sub.manager.model.OrderInfo;
import com.sub.manager.model.Patient;
import com.sub.manager.model.Schedule;
import com.sub.manager.service.HospitalService;
...
public class HospitalServiceImpl implements HospitalService {
    ...
    public Map<String, Object> submitOrder(Map<String, Object> paramMap) {
        ...
        boolean b = !schedule.getHoscode().equals(hoscode);
        boolean b1 = !schedule.getDepcode().equals(depcode);
        boolean b2 = !schedule.getAmount().equals(amount);
        if (b || b1 || b2) {
            throw new YyghException(ResultCodeEnum.DATA_ERROR);
        }
