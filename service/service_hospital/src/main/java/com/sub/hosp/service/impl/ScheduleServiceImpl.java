...
public class ScheduleServiceImpl implements ScheduleService {
    ...
    public Map<String, Object> getRuleSchedule(Integer page, Integer limit, String hoscode, String depcode) {
        ...
        long i = (page - 1) * limit;
        SkipOperation skip = Aggregation.skip(i);
        // size
    ...
    public Map<String, Object> getBookingScheduleRule(Integer page, Integer limit, String hoscode, String depcode) {
        ...
        ArrayList<BookingScheduleRuleVo> bookingScheduleRuleVoList = null;
        if (scheduleVoMap.size() > 0) {
    ...
    private IPage<Date> getListDate(Integer page, Integer limit, BookingRule bookingRule) {
        ...
        for (int i = 0; i < cycle; i++) {
            ...
            dateList.add(new DateTime(dateString).plusHours(8).toDate());
        }
